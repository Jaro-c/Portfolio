	...
	return (
		<div className="flex flex-col items-center space-y-[2rem]">
			<Link href="#contact" passHref>
				<button className="border border-gray-500 rounded-full px-[4rem] py-[.8rem] transition-transform duration-300 ease-in-out hover:scale-110">
			...
			<div className="flex items-center space-x-[.6rem]">
				<div className="relative flex items-center justify-center w-[.6rem] h-[.6rem]">
					<div className={`animate-ping absolute w-full h-full rounded-full opacity-75 ${status ? 'bg-green-400' : 'bg-red-400'}`}></div>
